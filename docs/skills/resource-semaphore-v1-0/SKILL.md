---
name: resource-semaphore-v1-0
description: Generates Python concurrency code using version v1.0.* of the resource-semaphore library to apply multi-resource backpressure. Use this when the user needs to manage constrained resources like CPU, RAM, or DB connections across threads or asyncio tasks.
---
...
- **Fairness**: The library uses strict FIFO head-of-line blocking.
