---
name: resource-semaphore-v1-2
description: Generates Python concurrency code using version v1.2.* of the resource-semaphore library to apply multi-resource backpressure. Use this when the user needs to manage constrained resources like CPU, RAM, or DB connections across threads or asyncio tasks.
---
